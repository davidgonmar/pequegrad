...
def test_resize():
    ...
    pg_resized = pg_cv2.resize(pg_cv2.numpy_to_tensor(img), (50, 50), pg_cv2.INTER_NEAREST).numpy()
...
def AAtest_cvtColor():
    ...
    pg_gray = pg_cv2.cvtColor(pg_cv2.numpy_to_tensor(img), pg_cv2.COLOR_BGR2GRAY).numpy().squeeze()
...
def test_gaussian_blur():
    ...
    pg_blur = pg_cv2.GaussianBlur(pg_cv2.numpy_to_tensor(img), (5, 5), sigmaX=1.0).numpy()

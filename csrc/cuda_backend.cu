...
using NpArrayVariant = std::variant<py::array_t<float>, py::array_t<int>, py::array_t<double>>;
...
PYBIND11_MODULE(pequegrad_cu, m) {
  ...
  py::class_<CudaArray>(m, "CudaArray")                                            
      ...
      .def("to_numpy", [](const CudaArray &arr) -> NpArrayVariant {
        switch (arr.dtype) {
          case DType::Float32:
      ...
      .def("__repr__",                                                         
           [](const CudaArray &arr) { return arr.to_string(); })            
      .def(                                                                    
          "add",                                                               
      ...
      .def("exp",                                                              
           [](const CudaArray &arr) { return arr.elwiseop(UnaryKernelType::EXP); })  
      .def("log",                                                              
           [](const CudaArray &arr) { return arr.elwiseop(UnaryKernelType::LOG); }) 
      ...
      .def("squeeze", [](const CudaArray &arr,                              
      ...
      .def("col2im",                                                           
           [](const CudaArray &arr, shape_t kernel_shape,                   
              shape_t output_shape, size_t stride) {                           
             return arr.col2im(kernel_shape, output_shape, stride);            
           })                                                                  
      .def_static("fill", [](shape_t shape,                  
                             py::handle value, const std::string &dtype) {                                
        if (dtype == "float32") {
      ...
      .def("__getitem__", [](const CudaArray &arr, shape_t index) -> ItemVariant {         
  switch (arr.dtype) {
    case DType::Float32:

...
print(f"Average time taken for amp_matmul over {num_iterations} iterations: {average_time_amp:.6f} seconds")
print(f"Average time taken for regular matmul over {num_iterations} iterations: {average_time_regular:.6f} seconds")
